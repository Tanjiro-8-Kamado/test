Feature: To check bidding flow from My Lot page on auction live stage
    ...
    Scenario: SM_AL_LLP_13  verify user able to see current bid amount is available in dollar on required lot in my lots page
    ...
    Then I verify current bid amount is available in dollar on required lot in my lots page

    @regression @high @qastaging @auctionlive 
    Scenario: SM_AL_LLP_14  verify user able to see next bid text is available in next bid amount section on required lot in my lots page
    Given I am on the derivaz and Ives homepage 
    When I click on accept cookie button
    When I click on the 'Login' link from homepage
    And I type valid username and password on the login page
    ...
    When I click on view my lots button from lot list page
    When I select saved lots auction from dropdown in my lots page
    Then I verify next bid text is available in next bid amount section on required lot in my lots page

    @regression @high @qastaging @auctionlive 
    Scenario: SM_AL_LLP_15  verify user able to see next bid amount is available in rupee on required lot in my lots page
    Given I am on the derivaz and Ives homepage
    When I click on accept cookie button
    When I click on the 'Login' link from homepage
    And I type valid username and password on the login page
    ...
    When I click on view my lots button from lot list page
    When I select saved lots auction from dropdown in my lots page
    Then I verify next bid amount is available in rupee on required lot in my lots page

    @regression @high @qastaging @auctionlive 
    Scenario: SM_AL_LLP_16  verify user able to see next bid amount is available in dollar on required lot in my lots page
    Given I am on the derivaz and Ives homepage 
    When I click on accept cookie button
    When I click on the 'Login' link from homepage
    And I type valid username and password on the login page
    ...
    When I click on view my lots button from lot list page
    When I select saved lots auction from dropdown in my lots page
    Then I verify next bid amount is available in dollar on required lot in my lots page